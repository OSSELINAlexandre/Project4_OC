...
public class FareCalculatorServiceTest {
	...
	// Test with 29 minutes and 59 seconds of parking (1799 seconds), should be free
	@Test
	...
	// Test with exactly 30 minutes of parking (1800 seconds), should be charged
	@Test
	...
	// Test with 30 minutes and one second of parking (1801 seconds), should be
	// charged
	@Test
	...
	// Test with 29 minutes and 59 seconds of parking (1799 seconds), should be free
	@Test
	public void calculateFareBikeWithLessThan30MinutesParkingTime_ShouldBeFree() {
		Date inTime = new Date();
		inTime.setTime(System.currentTimeMillis() - (60 * 30 * 1000) + 1000); // 1000 Ms is adding a second to the -30
		// minutes from current time
		Date outTime = new Date();
	...
	// Test with exactly 30 minutes of parking (1800 seconds), should be charged
	@Test
	public void calculateFareBikeWithExactly30minutesParkingTime_ShouldBeCharged() {
		Date inTime = new Date();
		inTime.setTime(System.currentTimeMillis() - (60 * 30 * 1000));
		Date outTime = new Date();
		ParkingSpot parkingSpot = new ParkingSpot(1, ParkingType.BIKE, false);
	...
	public void calculateFareBikeWithMoreThan30MinutesParkingTime() {
		...
		ticket.setParkingSpot(parkingSpot);
		fareCalculatorService.calculateFare(ticket);
		assertEquals(((1801.0 / 3600.0) * Fare.BIKE_RATE_PER_HOUR), ticket.getPrice());
	}
	...
	@Test
	public void calculateFareBikeWith15DaysParkingTime() {
		Date inTime = new Date();
		...
		ticket.setParkingSpot(parkingSpot);
		fareCalculatorService.calculateFare(ticket);
		assertEquals((15.0 * 24.0 * Fare.BIKE_RATE_PER_HOUR), ticket.getPrice());
	}
